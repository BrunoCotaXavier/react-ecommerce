...
const Budget = () => {
    ...
    return (
        <div className="budget-container">
            <button className="budget-button">SOLICITE SEU ORÇAMENTO</button>
            ...
            <div className="budget-about">
                <div className="budget-about-item">
                    <img src="https://static.wixstatic.com/media/03db72_1bf92f9d97274db29bae93a18b12557b~mv2.png/v1/fill/w_262,h_274,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Ícone%20Prazo%202.png"></img>
                    <h3>PRAZO</h3>
                    <p>Entendemos a importância do seu pedido/evento e cumprimos o prazo combinado.</p>
                </div>
                <div className="budget-about-item2">
                    <img src="https://static.wixstatic.com/media/03db72_da13ecccebe74b75a519bfd3bec1c8f5~mv2.png/v1/fill/w_256,h_224,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Ícone%20Qualidade.png"></img>
                    <h3>PRAZO</h3>
                    <p>Entendemos a importância do seu pedido/evento e cumprimos o prazo combinado.</p>
                </div>
                <div className="budget-about-item">
            ...
            <form className="budget-input-container">
                <fieldset className="budget-fieldset">
                    <legend><stron>Solicite seu orçamento!</stron></legend>

                    <label className="budget-label">Nome *</label>
                    <input 
                    type="text" value={nome} 
                    onChange={(e) => setNome(e.target.value)} 
                    className={nome ? (validateNome ? 'valid' : 'invalid') : ''} 
                    ...
                    className={email ? (validateEmail ? 'valid' : 'invalid') : ''} 
                    ...
                    className={celular ? (validateCelular ? 'valid' : 'invalid') : ''}
                    ...
                    <input 
                        ...
                        className={empresa ? (validateEmpresa ? 'valid' : 'invalid') : ''}
                    />
                    ...
                    <input 
                        ...
                        className={loc ? (validateLoc ? 'valid' : 'invalid') : ''}
                    />
                    ...
                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="camiseta" />
                        <span className="checkmark"></span>
                        Camiseta
                    </label>
                    
                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="camisa-polo" />
                        <span className="checkmark"></span>
                        Camisa Pólo
                    </label>

                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="samba-shortdoll" />
                        <span className="checkmark"></span>
                        Samba e Short Doll
                    </label>

                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="blusoes" />
                        <span className="checkmark"></span>
                        Blusões de Moletom
                    </label>

                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="pijama" />
                        <span className="checkmark"></span>
                        Calça de Pijama
                    </label>

                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="ecobags" />
                        <span className="checkmark"></span>
                        Ecobags
                    </label>

                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="bones" />
                        <span className="checkmark"></span>
                        Bonés
                    </label>

                    <label class="checkbox-item">
                        <input type="checkbox" name="produtos" value="outros" />
                        <span className="checkmark"></span>
                        Outros
                    </label>
                    ...
                    <label class="checkbox-item">    
                        <input type="radio" name="produtos" value="outros" />
                        <span className="checkmark"></span>
                        Sim
                    </label>
                    ...
                    <p>Recomendamos uma arte em alta qualidade</p>

                    <button className="budget-button">ENVIAR SOLICITAÇÃO</button>
